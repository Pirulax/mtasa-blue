...
public:
    ...
    virtual bool              QueryWithFailedCheck(SConnectionHandle hConnection, const char* szQuery, ...);
...
//
///////////////////////////////////////////////////////////////
bool CDatabaseManagerImpl::QueryWithFailedCheck(SConnectionHandle hConnection, const char* szQuery, ...)
{
    va_list vl;
    va_start(vl, szQuery);
