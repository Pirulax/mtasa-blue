...
public:
    ...
    bool CallStateChaningEvents(CElement* const eventSourceElem, const EResourceState oldState, const char* otherEventName, const CLuaArguments* const otherEventArguments, const bool cancellable = true);
