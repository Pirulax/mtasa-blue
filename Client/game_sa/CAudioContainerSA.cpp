...
const SString CAudioContainerSA::GetAudioArchiveName(eAudioLookupIndex lookupIndex)
{
    ...
    switch (lookupIndex)
    {
        case AUDIO_LOOKUP_FEET:
            archiveName += "FEET";
            break;
        case AUDIO_LOOKUP_GENRL:
            archiveName += "GENRL";
            break;
        case AUDIO_LOOKUP_PAIN_A:
            archiveName += "PAIN_A";
            break;
        case AUDIO_LOOKUP_SCRIPT:
            archiveName += "SCRIPT";
            break;
        case AUDIO_LOOKUP_SPC_EA:
            archiveName += "SPC_EA";
            break;
        case AUDIO_LOOKUP_SPC_FA:
            archiveName += "SPC_FA";
            break;
        case AUDIO_LOOKUP_SPC_GA:
            archiveName += "SPC_GA";
            break;
        case AUDIO_LOOKUP_SPC_NA:
            archiveName += "SPC_NA";
            break;
        case AUDIO_LOOKUP_SPC_PA:
            archiveName += "SPC_PA";
            break;
    }
    return archiveName;
...
bool CAudioContainerSA::GetRadioAudioData(eRadioStreamIndex streamIndex, int trackIndex, void*& pMemory, unsigned int& length)
{
    ...
    if (pData[0] != 'O' || pData[1] != 'g' || pData[2] != 'g' || pData[3] != 'S')
    {
        delete[] pData;
        return false;
    }
...
const SString CAudioContainerSA::GetRadioStreamArchiveName(eRadioStreamIndex streamIndex)
{
    switch (streamIndex)
    {
        case RADIO_STREAM_POLICE:
            return "AUDIO\\STREAMS\\AA";
        case RADIO_STREAM_ADVERTS:
            return "AUDIO\\STREAMS\\ADVERTS";
        case RADIO_STREAM_AMBIENCE:
            return "AUDIO\\STREAMS\\AMBIENCE";
        case RADIO_STREAM_BEATS:
            return "AUDIO\\STREAMS\\BEATS";
        case RADIO_STREAM_PLAYBACK:
            return "AUDIO\\STREAMS\\CH";
        case RADIO_STREAM_KROSE:
            return "AUDIO\\STREAMS\\CO";
        case RADIO_STREAM_KDST:
            return "AUDIO\\STREAMS\\CR";
        case RADIO_STREAM_CUTSCENE:
            return "AUDIO\\STREAMS\\CUTSCENE";
        case RADIO_STREAM_BOUNCE:
            return "AUDIO\\STREAMS\\DS";
        case RADIO_STREAM_SFUR:
            return "AUDIO\\STREAMS\\HC";
        case RADIO_STREAM_RADIO_LOS_SANTOS:
            return "AUDIO\\STREAMS\\MH";
        case RADIO_STREAM_RADIO_X:
            return "AUDIO\\STREAMS\\MR";
        case RADIO_STREAM_CSR:
            return "AUDIO\\STREAMS\\NJ";
        case RADIO_STREAM_KJAH:
            return "AUDIO\\STREAMS\\RE";
        case RADIO_STREAM_MASTER_SOUNDS:
            return "AUDIO\\STREAMS\\RG";
        case RADIO_STREAM_WCTR:
            return "AUDIO\\STREAMS\\TK";
    }
