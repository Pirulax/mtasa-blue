...
{
    RADIO_STREAM_POLICE,
    RADIO_STREAM_ADVERTS,
    RADIO_STREAM_AMBIENCE,
    RADIO_STREAM_BEATS,
    RADIO_STREAM_PLAYBACK,
    RADIO_STREAM_KROSE,
    RADIO_STREAM_KDST,
    RADIO_STREAM_CUTSCENE,
    RADIO_STREAM_BOUNCE,
    RADIO_STREAM_SFUR,
    RADIO_STREAM_RADIO_LOS_SANTOS,
    RADIO_STREAM_RADIO_X,
    RADIO_STREAM_CSR,
    RADIO_STREAM_KJAH,
    RADIO_STREAM_MASTER_SOUNDS,
    RADIO_STREAM_WCTR
};
