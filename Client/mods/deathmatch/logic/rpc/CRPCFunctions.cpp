...
SFixedArray<CRPCFunctions::SRPCHandler, NUM_RPC_FUNCS>        CRPCFunctions::m_RPCHandlers;
SFixedArray<CRPCFunctions::SElementRPCHandler, NUM_RPC_FUNCS> CRPCFunctions::m_ElementRPCHandlers;
