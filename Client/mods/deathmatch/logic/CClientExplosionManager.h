...
public:
    ...
    CExplosion* Create(eExplosionType explosionType, CVector& vecPosition, CClientEntity* pCreator = NULL, bool bMakeSound = true, float fCamShake = -1.0f,
                       bool bNoDamage = false, eWeaponType responsibleWeapon = WEAPONTYPE_UNARMED);
