...
public:
    ...
    virtual Ret operator()(Arguments Args) const { return m_fnCallback(Args); }
...
public:
    ...
    CCallback(CallbackFunction pfnCallback) { m_pCallback = new CCallbackFree<Ret, Arguments>(pfnCallback); }
